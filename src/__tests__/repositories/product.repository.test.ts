...
describe("Product Repository", () => {
  ...
  describe("getAll", () => {
    it("should return products with pagination", async () => {
      ...
      (Product.findAndCountAll as jest.Mock).mockResolvedValue({ count: 1, rows: mockProducts });
    ...
    it("should filter by category", async () => {
      ...
      const result = await productRepository.getAll({ category: "electronics" });
      expect(result.products).toEqual(mockProducts);
    });
    ...
    it("should filter by minPrice and maxPrice", async () => {
      ...
      const result = await productRepository.getAll({ minPrice: 50, maxPrice: 200 });
      expect(result.products).toEqual(mockProducts);
    });
    ...
    it("should sort by valid field with ASC order", async () => {
      ...
      const result = await productRepository.getAll({ sortBy: "name", sortOrder: "asc" });
      expect(result.products).toEqual(mockProducts);
    });
    ...
    it("should sort by valid field with DESC order", async () => {
      ...
      const result = await productRepository.getAll({ sortBy: "price", sortOrder: "desc" });
      expect(result.products).toEqual(mockProducts);
    });
    ...
    it("should not sort by invalid field", async () => {
      ...
      const result = await productRepository.getAll({ sortBy: "invalid", sortOrder: "asc" });
      expect(result.products).toEqual(mockProducts);
    });
  });
  ...
  describe("getOneById", () => {
    it("should return product by id", async () => {
      ...
      expect(Product.findByPk).toHaveBeenCalledWith(1, { transaction: undefined });
    });
  ...
  describe("getByIds", () => {
    it("should return products by ids", async () => {
      ...
      expect(Product.findAll).toHaveBeenCalledWith({ where: { id: [1, 2] }, transaction: undefined });
    });
  });
  ...
  describe("createOne", () => {
    it("should create product", async () => {
      ...
      expect(product).toEqual(mockProduct);
      expect(Product.create).toHaveBeenCalledWith(productData, { transaction: undefined });
    });
  });
  ...
  describe("updateOneById", () => {
    it("should update product", async () => {
      ...
      const mockProduct = { id: 1, name: "Updated Product", update: jest.fn().mockResolvedValue(undefined) };
      (Product.findByPk as jest.Mock).mockResolvedValue(mockProduct);

      const product = await productRepository.updateOneById(1, updateData);
      expect(product).toEqual(mockProduct);
      expect(mockProduct.update).toHaveBeenCalledWith(updateData, { transaction: undefined });
    });

    it("should return null if product not found", async () => {
      (Product.findByPk as jest.Mock).mockResolvedValue(null);

      const product = await productRepository.updateOneById(999, { name: "Updated" });
      expect(product).toBeNull();
    });
  });
  ...
  describe("deleteOneById", () => {
    it("should delete product", async () => {
      const mockProduct = { id: 1, name: "Deleted Product", destroy: jest.fn().mockResolvedValue(undefined) };
      (Product.findByPk as jest.Mock).mockResolvedValue(mockProduct);
